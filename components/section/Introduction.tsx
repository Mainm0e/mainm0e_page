...
export default function Introduction() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:py-8 md:px-32">
      <div className="bg-accent flex md:flex-row flex-col  border-4 border-primary shadow-lg">
        ...
        <div className="md:pl-16 flex justify-center  md:border-l-4 max-sm:border-t-4 border-primary shadow-lg">
          <div className="md:px-8 md:py-16">
            <h1 className="text-3xl md:text-5xl leading-relaxed md:leading-snug font-bold text-primary text-center md:text-left">
              Hi, I'm Adi
            </h1>
